...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("occMsInventory");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("occMsInventory");
        ...
        config.getMapConfigs().put("com.yonyou.occ.ms.inventory.domain.*", initializeDomainMapConfig(jHipsterProperties));
