...
public class SoItemResource {
    ...
    public ResponseEntity<SoItemDTO> createSoItem(@Valid @RequestBody SoItemDTO soItemDTO) throws URISyntaxException {
        ...
        soItem.setId(UUID.randomUUID().toString());
    ...
    @Timed
    public ResponseEntity<SoItemDTO> getSoItem(@PathVariable String id) {
    ...
    @Timed
    public ResponseEntity<Void> deleteSoItem(@PathVariable String id) {
