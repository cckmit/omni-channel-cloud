...
/**
 * A DTO for the SoType entity.
 */
public class SoTypeDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        SoTypeDTO soTypeDTO = (SoTypeDTO) o;
        if(soTypeDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), soTypeDTO.getId());
    }
