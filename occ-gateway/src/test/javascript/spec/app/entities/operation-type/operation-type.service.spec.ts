...
describe('Service Tests', () => {
    ...
    describe('OperationType Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(OperationTypeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + '/occmsinventory/api/operation-types';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OperationType', () => {

                let entity: OperationType;
                service.find(123).subscribe((_entity: OperationType) => {
                    entity = _entity;
                });
