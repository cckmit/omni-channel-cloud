...
describe('Service Tests', () => {
    ...
    describe('PurchaseOrder Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PurchaseOrderService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + '/occmsorder/api/purchase-orders';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + "123");
            });
            it('should return PurchaseOrder', () => {

                let entity: PurchaseOrder;
                service.find("123").subscribe((_entity: PurchaseOrder) => {
                    entity = _entity;
                });
