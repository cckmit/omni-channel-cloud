...
describe('Service Tests', () => {
    ...
    describe('CustomerAccount Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CustomerAccountService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + '/occmscustomer/api/customer-accounts';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + "123");
            });
            it('should return CustomerAccount', () => {

                let entity: CustomerAccount;
                service.find("123").subscribe((_entity: CustomerAccount) => {
                    entity = _entity;
                });
