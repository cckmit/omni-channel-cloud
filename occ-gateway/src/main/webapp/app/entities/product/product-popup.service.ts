        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.productService.find(id).subscribe((product) => {
                    product.ts = this.datePipe
                        .transform(product.ts, 'yyyy-MM-ddTHH:mm:ss');
                    product.timeCreated = this.datePipe
                        .transform(product.timeCreated, 'yyyy-MM-ddTHH:mm:ss');
                    product.timeModified = this.datePipe
                        .transform(product.timeModified, 'yyyy-MM-ddTHH:mm:ss');
