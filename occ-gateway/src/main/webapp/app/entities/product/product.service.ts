...
export class ProductService {
    ...
    private resourceUrl =  SERVER_API_URL + '/occmsproduct/api/products';
    ...
    private convert(product: Product): Product {
        ...
        copy.ts = this.dateUtils.toDate(product.ts);

        copy.timeCreated = this.dateUtils.toDate(product.timeCreated);

        copy.timeModified = this.dateUtils.toDate(product.timeModified);
        return copy;
    }
}
