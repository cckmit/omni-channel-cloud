...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("occMsCustomer");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("occMsCustomer");
        ...
        config.getMapConfigs().put("com.yonyou.occ.ms.customer.domain.*", initializeDomainMapConfig(jHipsterProperties));
